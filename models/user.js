...
const UserSchema = new mongoose.Schema({
    ...
    SentRequests:[{name:String,iduser:mongoose.Schema.Types.ObjectId,imageFriend:String,title:String}],
    ReceivedRequests:[{name:String,iduser:mongoose.Schema.Types.ObjectId,imageFriend:String,title:String}],
